...
const courses = [
  {
      ...
      },
      {
        ...
        experiments: [
          ...
          },
          {
            ...
            description: 'A particle on a circle with its tangent-velocity and inward-acceleration vectors, a released no-force ghost, a Δv construction, and a hodograph.',
            moment: 'Pause and ask which way the acceleration points. It points inward, always.',
            due: 'Aug 21',
            status: 'built',
      ...
      },
      {
        ...
        experiments: [
          ...
          },
          {
            ...
            description: 'A block on a track under an applied force, with mass and optional kinetic friction. The camera follows the block while a velocity-vs-time strip shows v climbing along a straight line whose slope is the acceleration.',
            moment: 'Constant net force gives a straight-line v(t): double the force and the slope doubles; double the mass and it halves.',
            due: 'Sep 1',
            status: 'built',
            component: lazy(() => import('./courses/sp211/ch04-newton/SecondLaw')),
          },
          {
            slug: 'atwood',
            dLabel: 'D08',
            title: 'Atwood Machine',
            description: 'Two masses on a string over a frictionless pulley. The heavier side falls and the lighter rises with a shared acceleration a = (m2 − m1)g/(m1 + m2); live force arrows show the single tension sitting between the two weights.',
            moment: 'The system accelerates on the difference of the weights over the total mass, and the one tension lies between m1g and m2g.',
            due: 'Sep 1',
            status: 'built',
            component: lazy(() => import('./courses/sp211/ch04-newton/Atwood')),
          },
        ],
      },
      {
        ...
        experiments: [
          ...
          },
          {
            ...
            dLabel: 'D13',
            title: 'Banked Curve',
            description: 'Side-view cutaway of a banked turn showing the normal force, weight, and friction on the car. Friction flips from up-slope to down-slope as the speed crosses the design speed v_d = √(r g tanθ), and a grip-budget gauge shows when the car breaks loose.',
            moment: 'At the design speed a banked turn needs no friction at all; below it friction points up the bank, above it, down.',
            due: 'Aug 29',
            status: 'built',
            component: lazy(() => import('./courses/sp211/ch05-applications/BankedCurve')),
          },
          {
            slug: 'cm',
            dLabel: 'D14',
            ...
            moment: 'Toggle the CM trail on a tumbling L-shaped body: the chaos resolves into a single clean parabola.',
            due: 'Aug 31',
            status: 'built',
            modes: [
    ...
    lessons: [
      ...
      { n: 13, topic: 'Curved paths, UCM dynamics', chapter: 'ch05-applications', experiment: 'banked', mode: 'default', dLabel: 'D13' },
